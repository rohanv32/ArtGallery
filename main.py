...
def scrape_saatchi_art(artist_name, artwork_title):
    ...
    try:
        ...
        for artwork in artworks:
            ...
            # Extracts the artist info, location, price, and artwork link
            artist_info = artwork.find('div', {'data-type': 'artist-info'})
            artist_name = (artist_info.find('p', {'data-type': 'artist-name'}).text.strip() 
                           if artist_info.find('p', {'data-type': 'artist-name'}) else 'Unknown Artist')
        ...
        return saatchi_artworks  # This returns the list of Saatchi artworks
    except requests.exceptions.RequestException as e:
...
if __name__ == "__main__":
    ...
    user_input = input("Enter the name of the artwork you'd like to take a look at (e.g. The Water Lily Pond: ")
